...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            var userEmailClaim = externalUser.FindFirst(JwtClaimTypes.Email) ??
            ...
            if (user == null)
            {
                ...
                user = AutoProvisionUser(userEmailClaim.Value);
            }
            ...
            var providerUserId = user.Id.ToString();
            await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId, providerUserId, user.Email));
        ...
        private User AutoProvisionUser(string email)
        {
            ...
            u.Roles = new List<string>() { "Visitor" };
